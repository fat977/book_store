            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{url('admin/add-edit-book')}}" class="btn btn-block btn-primary">Add Book</a>
                        ...
                        <div class="table-responsive pt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a  href="{{ url('admin/add-edit-book/'.$book['id']) }}"><i style="font-size: 20px" class="fas fa-user-edit"></i></a>
